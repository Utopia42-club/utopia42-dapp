                    ...
                    <Tbody>
                    {
                            verses.map((item, index) => (
                                <Tr key={index} id={index}>
                                    ...
                                    <Td  style={{width:'10%'}}><a target="_blank" href={'https://verse.utopia42.club/137/' + item}>{names[index]}</a></Td>
                                    {/* <Td style={{width:'25%'}}><a target="_blank" href={'https://verse.utopia42.club/137/' + item}>{item}</a></Td> */}
