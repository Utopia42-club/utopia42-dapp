...
const RegisterButton = (props) => {
  ...
  if (!account)
    ...
    contentBtn = (
      ...
      >
        ...
        contentBtn = (
          <Button margin="25px 0 0" background="#5F5CFE" onClick={handleRegister}>
            Register
          </Button>
        )
  }

  else if(status == 'Registered before') {
  ...
  else if(status === "You'r wallet is not registered on brightID") {
    contentBtn = (
      <Button 
        margin="25px 0 0"
        background={'rgba(255, 164, 81, 0.2)'}
